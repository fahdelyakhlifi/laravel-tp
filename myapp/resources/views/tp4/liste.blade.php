...
@section('content')
<div class="container mx-auto px-6 py-10 bg-gray-100 min-h-screen" id="messages">
    ...
    <div class="flex items-center mb-6" style="gap: 16px;">
        ...
        <form action="{{ route('products.index') }}" method="GET" class="flex items-center" style="margin-right: 16px;">
            ...
            <button type="submit" class="bg-sky-700 text-white px-4 py-2 rounded">
                Recherche
            </button>
            <!-- Bouton de Recherche AJAX -->
            <button onclick="loadData()" class="bg-sky-700 text-white px-4 py-2 rounded">
                Recherche AJAX
            </button>
        </form>
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="py-3 px-4 text-center space-x-2">
                        ...
                        <form action="{{ route('products.destroy', $product->id) }}" method="POST" class="inline">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-700 transition">Supprimer</button>
                        </form>
                    </td>
                </tr>
                @endforeach
    ...
    function loadData (){
            $.ajax({
                    ...
                    success: function (resulta) {
                        $("#table-resulta").html(resulta.html);
                    },
                });
        }
</script>
